locals {
  ...
  masters_iam_policies_arns = "${length(element(concat(var.k8s_masters_iam_policies_arns,""),0)) != 0 ? var.k8s_masters_iam_policies_arns : local.local_nodes_policies_arns_list}"
  nodes_iam_policies_arns   = "${length(element(concat(var.k8s_masters_iam_policies_arns,""),0)) != 0 ? var.k8s_masters_iam_policies_arns : local.local_nodes_policies_arns_list}"
